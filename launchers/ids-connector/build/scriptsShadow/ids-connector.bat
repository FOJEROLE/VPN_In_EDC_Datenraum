...
set CLASSPATH=%APP_HOME%\lib\dataspace-connector.jar

@rem Execute ids-connector
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %IDS_CONNECTOR_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%IDS_CONNECTOR_EXIT_CONSOLE%" exit 1
exit /b 1
