...
//include(":launchers:ids-connector:status-checker")
include(":launchers:ids-connector:transfer-file-local")
//include(":launchers:ids-connector:transfer-pull-http-dynamic-receiver")
